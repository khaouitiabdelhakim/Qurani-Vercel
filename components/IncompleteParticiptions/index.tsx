...
const IncompleteParticiptions = () => {
  ...
  const handleDownloadCSV = () => {
    ...
    link.download = "incomplete-participations.csv";
  ...
  useEffect(() => {
    ...
    const participationRef = ref(database, "fintech/2024/incomplete-participations");
  ...
  return (
    ...
    >
      <div className="container">
        <SectionTitle
          title="Incomplete Participations"
          paragraph="Here you can find out all the incomplete participations to the hackathon and download the data in .csv format."
          center
        />
...
export default IncompleteParticiptions;
