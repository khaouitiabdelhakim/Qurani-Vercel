...
const InCompleteParticipation = () => {
  ...
  const handleSubmit = (e, formData) => {
    ...
    setError(true);
    setMessage("The deadline for participation has passed. You can no longer participate.");
    return;

    setUploading(true);
    const participationsRef = ref(
      database,
      "fintech/2024/incomplete-participations",
    );
    ...
    set(newParticipationRef, {
      ...
      .then(() => {
        setSuccesMessages(
          "Your request is registred with success. No further action is required.",
        );
        setSuccess(true);
        setUploading(false);
                ...
                <div className="w-full px-4 md:w-1/2">
                  <div className="mb-8">
                    <label
                      ...
                      className="mb-3 block text-sm font-medium text-dark dark:text-white"
                    >
                      2<sup>nd</sup> Member Name - fill in this just if there is
                      a 2<sup>nd</sup> person!
                    </label>
                    <input
                ...
                <div className="w-full px-4 md:w-1/2">
                  <div className="mb-8">
                    <label
                      ...
                      className="mb-3 block text-sm font-medium text-dark dark:text-white"
                    >
                      3<sup>rd</sup> Member Name - fill in this just if there is
                      a 3<sup>rd</sup> person!
                    </label>
                    <input
                ...
                <div className="w-full px-4 md:w-1/2">
                  <div className="mb-8">
                    <label
                      ...
                      className="mb-3 block text-sm font-medium text-dark dark:text-white"
                    >
                      4<sup>th</sup> Member Name - fill in this just if there is
                      a 4<sup>th</sup> person!
                    </label>
                    <input
                ...
                <div className="w-full px-4 md:w-1/2">
                  <div className="mb-8">
                    <label
                      ...
                      className="mb-3 block text-sm font-medium text-dark dark:text-white"
                    >
                      5<sup>th</sup> Member Name - fill in this just if there is
                      a 5<sup>th</sup> person!
                    </label>
                    <input
                ...
                <div className="w-full px-4">
                  <div className="mb-8">
                    <label
                      ...
                      className="mb-3 block text-sm font-medium text-dark dark:text-white"
                    >
                      Project Description [max 600 characters] - Only if you
                      have it
                    </label>
                    <textarea
                      maxLength={600}
                ...
                <div className="w-full px-4 md:w-1/2">
                  <div className="mb-8">
                    <label
                      ...
                      className="mb-3 block text-sm font-medium text-dark dark:text-white"
                    >
                      Project Title - Only if you have it
                    </label>
                    <input
                      name="projectTitle"
...
export default InCompleteParticipation;
