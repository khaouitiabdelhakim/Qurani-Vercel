    ...
    onValue(participationRef, (snapshot) => {
      ...
      if (data) {
        ...
        const dataArray = Object.keys(data)
          ...
          .filter((participation) => participation.isQualified === true); // Filter only qualified participations
  ...
  return (
    ...
    >
      <div className="container">
        <SectionTitle
          title="Teams"
          paragraph="Here you can find out all the teams of the hackathon and download the data in .csv format."
          center
        />
