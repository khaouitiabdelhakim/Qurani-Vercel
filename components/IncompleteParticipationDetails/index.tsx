...
const IncompleteParticipationDetails = () => {
  ...
  useEffect(() => {
    ...
    const participationsRef = ref(
      database,
      `fintech/2024/incomplete-participations/${id}`,
    );
  ...
  const deleteTeam = async () => {
    ...
    const participationRef = ref(database, `fintech/2024/incomplete-participations/${id}`); // Reference to the participation node in the database
...
export default IncompleteParticipationDetails;
